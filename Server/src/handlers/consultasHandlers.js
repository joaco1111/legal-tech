const {
  getAllConsulta,
} = require("../controllers/controllersComsultas/getAllConsulta");
const {
  createConsultaBd,
} = require("../controllers/controllersComsultas/postConsultaController");
const {
  deleteConsulta,
} = require("../controllers/controllersComsultas/deleteConsulta");
